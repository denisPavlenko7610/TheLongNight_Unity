...
namespace TLN.Gameplay.Saves
{
    public sealed class WorldSaveRegistry
    {
        ...
        private readonly HashSet<string> _destroyedSceneEntityIds =
            new HashSet<string>();
        ...
        public void Capture(WorldSaveData worldData)
        {
            ...
            PersistentWorldEntity[] entities = Object.FindObjectsByType<PersistentWorldEntity>(FindObjectsInactive.Include,
        ...
        public void Restore(WorldSaveData worldData)
        {
            ...
            DestroyRuntimeEntitiesMissingFromSave(
                entitiesById,
                worldData);
        ...
        private void DestroyRuntimeEntitiesMissingFromSave(Dictionary<string, PersistentWorldEntity> entitiesById,
            WorldSaveData worldData)
        {
            ...
            if (worldData.entities != null)
            {
                for (int i = 0; i < worldData.entities.Count; i++)
                {
                    ...
                    if (entityData == null ||
                        string.IsNullOrWhiteSpace(entityData.id))
                    {
                        continue;
                    }
