...
namespace TLN.Application.Localization
{
	public static class Loc
	{
		...
		public static string MainMenuMode => ui("main_menu.mode");
		public static string MainMenuSinglePlayer => ui("main_menu.single_player");
		public static string MainMenuSinglePlayerDescription => ui("main_menu.single_player_description");
		public static string MainMenuMultiplayer => ui("main_menu.multiplayer");
		public static string MainMenuMultiplayerDescription => ui("main_menu.multiplayer_description");
		public static string MainMenuNewGame => ui("main_menu.new_game");
		public static string MainMenuLoadGame => ui("main_menu.load_game");
		public static string MainMenuOptions => ui("main_menu.options");
		public static string MainMenuQuit => ui("main_menu.quit");
		public static string MainMenuHostGame => ui("main_menu.host_game");
		public static string MainMenuJoinGame => ui("main_menu.join_game");
		public static string MainMenuJoinCode => ui("main_menu.join_code");
